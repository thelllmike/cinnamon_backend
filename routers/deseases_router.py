...
# Path to your disease detection model file.
MODEL_PATH = "model/desseas_model.h5"
...
@router.post("/predict-disease", summary="Predict disease class from an uploaded image")
